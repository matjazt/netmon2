 ...
 * 
 * @Mapper(componentModel = "spring") makes this a Spring bean that can be
 *                        injected.
 *                        MapStruct generates the implementation at compile
 *                        time.
 */
...
public interface DeviceMapper {
     ...
     * 
     * @Mapping maps nested network.id to flat networkId field.
     */
     ...
     * MapStruct automatically generates this using toDto() for each element.
     */
    List<DeviceDto> toDtos(List<DeviceEntity> entities);

    /**
     * Convert Page of DeviceEntity to Page of DeviceDto.
     * Default method allows custom logic for Page mapping.
     */
